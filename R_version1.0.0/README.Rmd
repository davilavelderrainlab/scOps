...
To install scOps for R please use `devtools::install()` specifying the branch with \@ Or download the R_version1.0.0 folder and use `install.packages(path_to_R_version1.0.0, repos = NULL, type="source")`
